...
class Members::PaymentMethodsController < Members::ApplicationController
    ...
    respond_to do |format|
      ...
      format.html do
        if turbo_frame_request?
          render partial: "members/carts/saved_payment_methods",
                 locals: {
                   payment_methods:,
                   selected_method_id:,
                   error_message:
          ...
          redirect_to members_cart_redirect_path, notice: "Saved card removed.", status: :see_other
        else
          redirect_to members_cart_redirect_path,
    ...
    respond_to do |format|
      ...
      format.html do
        if turbo_frame_request?
          ...
          redirect_to members_cart_redirect_path, alert: "We couldn't find that saved card.", status: :see_other
        end
      end
    end
  end
